export default function TermsOfService() {
  return (
    <>
      ...
      <p>
        This website is operated by Tides of Liberty. Throughout the site, the
        terms “we”, “us” and “our” refer to Tides of Liberty. Tides of Liberty
      ...
      <p>
        ...
        <br />
        In no case shall Tides of Liberty, our directors, officers, employees,
      ...
      <p>
        You agree to indemnify, defend and hold harmless Tides of Liberty and
